...
<template>
  <div class="mx-auto max-w-4xl pb-16">
    ...
    <BaseCard shape="curved" class="dark:!bg-muted-900 mb-4 p-8 sm:mb-6">
      ...
      <div class="space-y-2 pt-6 text-center">
        ...
        <BaseParagraph size="sm" class="text-muted-500 dark:text-muted-400 mx-auto max-w-2xl">
          ...
          <code class="bg-muted-100 dark:bg-muted-700/70 text-primary-500 rounded p-1 font-mono">
              {{ command }}
            </code>
    ...
    <div class="mb-4 grid grid-cols-1 gap-4 sm:mb-6 sm:grid-cols-2 sm:gap-6">
      <div class="grid grid-cols-2 gap-4 sm:gap-6">
        <NuxtLink to="https://tairo.cssninja.io" taget="_blank" rel="noopener noreferrer" class="relative">
          <BaseCard shape="curved" elevated-hover
            class="dark:!bg-muted-900 hover:!border-primary-500 relative z-10 h-full p-4">
            <div class="flex h-full flex-col items-center justify-center gap-2">
              <div class="nui-mask nui-mask-hexed relative flex h-16 w-16 shrink-0 items-center justify-center">
                <div
                  class="animate-spin-slow from-primary-100 to-primary-500 dark:from-primary-800 absolute inset-0 flex h-full w-full items-center justify-center bg-gradient-to-tr blur-sm transition-all duration-200">
                </div>
                <div
                  class="nui-mask nui-mask-hexed dark:bg-muted-800 flex h-[60px] w-[60px] items-center justify-center bg-white">
                  <Icon name="ph:sidebar-duotone" class="text-primary-500 h-6 w-6" />
                </div>
              </div>
              <BaseText size="sm" class="text-muted-500 dark:text-muted-300">Online demo</BaseText>
            </div>
          </BaseCard>
        </NuxtLink>
          ...
          <BaseCard shape="curved" elevated-hover
            ...
            <div class="flex h-full flex-col items-center justify-center gap-2">
              <div class="nui-mask nui-mask-hexed relative flex h-16 w-16 shrink-0 items-center justify-center">
                ...
                <div
                  class="nui-mask nui-mask-hexed dark:bg-muted-800 flex h-[60px] w-[60px] items-center justify-center bg-white">
                  <Icon name="simple-icons:nuxtdotjs" class="text-success-500 relative -top-0.5 h-5 w-5" />
                </div>
              </div>
              <BaseText size="sm" class="text-muted-500 dark:text-muted-300">Nuxt documentation</BaseText>
            </div>
          </BaseCard>
        </NuxtLink>
          ...
          <BaseCard shape="curved" elevated-hover
            ...
            <div class="flex h-full flex-col items-center justify-center gap-2">
              <div class="nui-mask nui-mask-hexed relative flex h-16 w-16 shrink-0 items-center justify-center">
                ...
                <div
                  class="nui-mask nui-mask-hexed dark:bg-muted-800 flex h-[60px] w-[60px] items-center justify-center bg-white">
                  <Icon name="fa6-brands:github" class="relative -top-0.5 h-5 w-5 text-purple-500" />
                </div>
              </div>
              <BaseText size="sm" class="text-muted-500 dark:text-muted-300">Github Access</BaseText>
            </div>
          </BaseCard>
        </NuxtLink>
          ...
          <BaseCard shape="curved" elevated-hover
            ...
            <div class="flex h-full flex-col items-center justify-center gap-2">
              <div class="nui-mask nui-mask-hexed relative flex h-16 w-16 shrink-0 items-center justify-center">
                ...
                <div
                  class="nui-mask nui-mask-hexed dark:bg-muted-800 flex h-[60px] w-[60px] items-center justify-center bg-white">
                  <Icon name="fa6-brands:discord" class="relative -top-0.5 h-5 w-5 text-blue-500" />
                </div>
              </div>
              <BaseText size="sm" class="text-muted-500 dark:text-muted-300">Discord Server</BaseText>
            </div>
          </BaseCard>
        </NuxtLink>
      </div>
    ...
    <div class="flex items-center py-4">
      ...
      <span class="text-semibold text-muted-800d dark:text-muted-100 shrink px-4 font-sans text-lg font-semibold">Getting
        started</span>
      <div class="bg-muted-200 dark:bg-muted-800 h-px grow"></div>
    </div>
    ...
    <div class="flex flex-col gap-6">
        ...
        <BaseProse class="prose-p:my-0 max-w-full">
          <div>
            <div class="flex gap-2 sm:items-center">
              <Icon name="ph:number-circle-one-duotone" class="text-primary-500 h-8 w-8 shrink-0" />
              <p>
                Enable a layout in
      ...
      <BaseCard class="dark:!bg-muted-900 p-6" shape="rounded">
        <BaseProse class="prose-p:my-0 max-w-full">
          <div>
            <div class="flex gap-2 sm:items-center">
              <Icon name="ph:number-circle-two-duotone" class="text-primary-500 h-8 w-8 shrink-0" />
              <p>
      ...
      <BaseCard class="dark:!bg-muted-900 p-6" shape="rounded">
        <BaseProse class="prose-p:my-0 max-w-full">
          <div>
            <div class="flex gap-2 sm:items-center">
              <Icon name="ph:number-circle-three-duotone" class="text-primary-500 h-8 w-8 shrink-0" />
              <p>
      ...
      <BaseCard class="dark:!bg-muted-900 p-6" shape="rounded">
        <BaseProse class="prose-p:my-0 max-w-full">
          <div>
            <div class="flex gap-2 sm:items-center">
              <Icon name="ph:number-circle-four-duotone" class="text-primary-500 h-8 w-8 shrink-0" />
              <p>
      ...
      <BaseCard class="dark:!bg-muted-900 p-6" shape="rounded">
        <BaseProse class="prose-p:my-0 max-w-full">
          <div>
            <div class="flex gap-2 sm:items-center">
              <Icon name="ph:number-circle-five-duotone" class="text-primary-500 h-8 w-8 shrink-0" />
              <p>
      ...
      <BaseCard class="dark:!bg-muted-900 p-6" shape="rounded">
        <BaseProse class="prose-p:my-0 max-w-full">
          <div>
            <div class="flex gap-2 sm:items-center">
              <Icon name="ph:number-circle-six-duotone" class="text-primary-500 h-8 w-8 shrink-0" />
              <p>Continue learning with the</p>
            </div>
          </div>
        </BaseProse>
      </BaseCard>
