  ...
  <div
    ...
    <div
      ...
      <div
        ...
        <div class="px-2">
          <NuxtLink href="/nosotros" rel="noopener"
            class="text-muted-600 hover:text-primary-500 dark:text-muted-200 dark:hover:text-primary-400 text-sm transition-colors duration-300">
            Nosotros
          </NuxtLink>
        </div>
        ...
        <div class="px-2">
          <NuxtLink href="/productos" rel="noopener"
            class="text-muted-600 hover:text-primary-500 dark:text-muted-200 dark:hover:text-primary-400 text-sm transition-colors duration-300">
            Productos
          </NuxtLink>
        </div>
        <div class="px-2">
          <NuxtLink href="/servicios" rel="noopener"
            class="text-muted-600 hover:text-primary-500 dark:text-muted-200 dark:hover:text-primary-400 text-sm transition-colors duration-300">
            Servicios
          </NuxtLink>
        </div>
        <div class="px-2">
          <NuxtLink href="/sucursales" rel="noopener"
            class="text-muted-600 hover:text-primary-500 dark:text-muted-200 dark:hover:text-primary-400 text-sm transition-colors duration-300">
            Sucursales
          </NuxtLink>
        </div>
        <div class="px-2">
          <NuxtLink href="/contacto" rel="noopener"
            class="text-muted-600 hover:text-primary-500 dark:text-muted-200 dark:hover:text-primary-400 text-sm transition-colors duration-300">
            Contacto
          </NuxtLink>
        </div>
      </div>
      <div class="flex w-1/5 items-center justify-end gap-6">
