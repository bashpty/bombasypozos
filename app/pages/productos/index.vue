          ...
          <div class="col-span-12">
            <div class="bg-primary-800 flex flex-col items-center rounded-2xl p-4 sm:flex-row">
              <div class="relative h-[120px] w-[240px] shrink-0 sm:h-[175px]">
                <img class="pointer-events-none absolute -top-6 start-3 sm:-start-10 sm:-top-2"
                  src="/img/illustrations/dashboards/delivery/header.svg" alt="Food illustration" />
              </div>
              <div class="mt-6 grow sm:mt-0">
                <div class="pb-4 text-center sm:pb-0 sm:text-left">
                  ...
                  <div class="mt-2">
                    <BaseButton size="sm" color="light" flavor="outline" class="w-full sm:w-auto">
          ...
          <div class="relative">
            ...
            <div class="mb-14 grid grid-cols-4 gap-4 sm:grid-cols-9">
              ...
              <div class="hidden items-center justify-center sm:flex">
                <BaseButtonIcon shape="full" class="hover:border-yellow-500 hover:text-yellow-500"
            ...
            <div class="grid gap-x-3 gap-y-6 sm:grid-cols-3">
              <!-- Grid item -->
              <NuxtLink v-for="meal in meals" :key="meal.id" to="#" class="relative">
                <BaseCard shape="curved"
                  ...
                  <div class="ltablet:h-28 bg-muted-100 dark:bg-muted-900 relative mb-3 h-36 w-full rounded-xl sm:h-32">
                    <img
                  ...
                  <div class="mb-2">
                    <BaseHeading tag="h4" size="sm" weight="medium" class="text-muted-800 dark:text-muted-100">
                      <span>{{ meal.name }}</span>
                    </BaseHeading>
                  ...
                  <div class="flex items-center justify-between">
                    <div class="divide-muted-200 dark:divide-muted-700 flex items-center divide-x">
                      <div class="pe-4">
                        <span class="text-muted-800 dark:text-muted-100 font-sans font-bold">
                          ${{ meal.price }}
                        </span>
                      </div>
        ...
        <div class="bg-muted-200 dark:bg-muted-800 flex flex-col gap-6 rounded-2xl p-6">
          ...
          <div class="font-hairline rounded-2xl bg-primary-800 p-6 text-xs">
            <div class="mb-4 flex items-center gap-2">
              ...
              <div>
                <BaseHeading as="h4" size="sm" weight="light" lead="tight" class="text-white">
            ...
            <div class="mt-4 flex items-center gap-2 font-sans">
              ...
              <button type="button" class="ms-auto cursor-pointer text-yellow-400">
                Choose time
              </button>
            </div>
          </div>
              ...
              <div class="flex items-center gap-3">
                <div
                  ...
                  <div
                    ...
                    <span class="font-sans text-[0.65rem] font-semibold text-white">
                      x{{ item.quantity }}
                    </span>
                  </div>
                </div>
          ...
          <div class="border-muted-300 dark:border-muted-800 flex grow flex-col justify-end border-t py-4">
            ...
            <div class="mt-4 flex justify-between text-xs font-bold">
              <BaseButton color="none" shape="curved"
